        ...
        if (datas[i]) {
            ...
            <div class="card ribbon-box ribbon-fill">\
                ...
                <div class="card-body p-4 m-4">\
                    <button type="button" class="btn btn-sm btn-icon btn-subtle-danger position-absolute top-0 end-0 m-3" data-bs-toggle="modal" data-bs-target="#deleteRecordModal"><i class="ph-trash"></i></button>\
